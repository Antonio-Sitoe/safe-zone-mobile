...
const SelectionOverlayComponent = ({ isSelectionMode, zoneType }: SelectionOverlayProps) => {
	if (!isSelectionMode) {
		return null;
	}
	...
	return (
		<View style={styles.overlay} pointerEvents="box-none">
			...
			<View style={styles.instructionContainer}>
				<Text style={styles.instructionText}>Toque no mapa para selecionar a localização</Text>
			</View>
		</View>
	);
};
