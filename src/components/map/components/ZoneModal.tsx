      ...
      >
        <View style={styles.content}>
          <Text style={styles.title}>
            {editingZoneSlug ? 'Editar zona' : 'Nova zona'}
          </Text>
          <Text style={styles.subtitle}>
            Localização:{' '}
            {pendingCoordinate
              ? `${pendingCoordinate[1].toFixed(5)}, ${pendingCoordinate[0].toFixed(
                  5
                )}`
              : 'Seleciona no mapa'}
          </Text>
          ...
          <Text style={styles.hint}>
            Áreas com 10 ou mais relatos tornam-se críticas independentemente do
            tipo selecionado.
          </Text>
