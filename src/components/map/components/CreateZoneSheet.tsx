		...
		<Actionsheet isOpen={isOpen} onClose={onClose}>
			...
			<ActionsheetContent style={styles.sheetContent}>
				...
				<View style={styles.options}>
					...
					>
						<Text style={[styles.optionTitle, styles.safeText]}>Criar zona segura</Text>
						<Text style={styles.optionDescription}>
							Assinala locais com boa iluminação, presença policial e outras características
							positivas.
						</Text>
					</TouchableOpacity>
					...
					>
						<Text style={[styles.optionTitle, styles.dangerText]}>Criar zona de perigo</Text>
						<Text style={styles.optionDescription}>
							Reporta incidentes recentes, más condições ou qualquer situação de risco identificada.
						</Text>
					</TouchableOpacity>
				</View>
			</ActionsheetContent>
