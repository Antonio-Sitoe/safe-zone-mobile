							...
							>
								...
								<View className="flex-row justify-between mb-4">
									...
									>
										...
										<Text className="text-blue-700 font-medium font-body">Escolher Contactos</Text>
									</Pressable>
									...
									>
										<Text className="text-white font-semibold font-body">Adicionar</Text>
									</Pressable>
								</View>
								...
								<View className="mb-6 flex-row justify-between gap-3 space-y-3">
									...
									<Button variant="gray" size="lg" onPress={handleClose} className="flex-1">
