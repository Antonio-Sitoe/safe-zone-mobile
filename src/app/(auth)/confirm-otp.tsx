					...
					<ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 20 }}>
						<View className="flex-1 flex-col justify-between px-6 pt-8 pb-8 space-y-8">
							<View className="w-full mb-10">
								<Pressable onPress={() => router.back()} className="mr-4 p-2 flex-row items-center">
									<Entypo name="chevron-left" size={24} color="#374151" />
									<Text className="text-sm font-montserrat text-gray-700 ml-2">Voltar</Text>
								</Pressable>
							</View>
						...
						<ModalContent size="lg">
							...
							<ModalBody>
								<Text className="font-montserrat leading-7 text-gray-700 text-center text-base">
									...
									<Text className="font-bold font-montserrat text-app-primary">Mapa Seguro.</Text>{" "}
									{"\n"}
									Estamos animados por tê-lo(a) conosco.
								</Text>
							</ModalBody>
							<ModalFooter className="items-center mt- justify-center">
								<Button onPress={onClose} className="bg-app-primary rounded-xl h-14 w-2/3">
									<Text className="text-white font-montserrat text-sm ">Fechar</Text>
								</Button>
							</ModalFooter>
						</ModalContent>
					</Modal>
