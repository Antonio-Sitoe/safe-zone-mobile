				...
				<TouchableWithoutFeedback onPress={Keyboard.dismiss}>
					...
					>
						<View className="flex-row items-center justify-between px-6 py-4 border-b border-gray-200">
							...
							<Text className="text-lg font-semibold text-black">Editar Perfil</Text>
							<View style={{ width: 32 }} />
						</View>
						...
						<View className="px-6 space-y-6 gap-3">
							<View>
								...
								/>
								{profileErrors.name && (
									<Text className="text-red-500 text-sm mt-1">{profileErrors.name.message}</Text>
								)}
							</View>
							...
							<View>
								...
								<View className="bg-gray-100 px-4 py-3 rounded-lg border border-gray-200">
									<Text className="text-base text-gray-600">{user?.email || "Não informado"}</Text>
								</View>
								<Text className="text-xs text-gray-500 mt-1">O email não pode ser alterado</Text>
							</View>
							...
							<View>
								...
								/>
								{profileErrors.image && (
									<Text className="text-red-500 text-sm mt-1">{profileErrors.image.message}</Text>
								)}
							</View>
							...
							<View className="mt-8 pt-8 border-t border-gray-200">
								...
								>
									<View className="flex-row items-center gap-3">
										...
										<Text className="text-base font-semibold text-gray-800">Alterar Senha</Text>
									</View>
								...
								{showPasswordSection && (
									<View className="space-y-4 gap-4">
										...
										<Button
											...
											className="bg-[#1D2C5E] rounded-lg h-14"
										>
											{changePasswordMutation.isPending || isPasswordSubmitting ? (
												<ActivityIndicator color="white" />
											) : (
